...
CREATE TABLE payments (
    ...
    order_id BIGINT NOT NULL COMMENT 'Order ID (generated by distributed ID generator)',
    user_id BIGINT NOT NULL COMMENT 'User ID (generated by distributed ID generator)',
